...
def _yaml_configuration_factory(source: Path, staging_root: Path) -> YamlConfigurationRepository:
    return YamlConfigurationRepository(source, staging_root)


# Adapter-side registration keeps application/config_service.py provider-neutral.
ConfigService.register_directory_factory(_yaml_configuration_factory)
